...
/**
 * Исключение, которое выбрасывается при попытке удалить(сделать неактивным) зал с активными сеансами
 */
public class HallHasActiveSessionsException extends RuntimeException {
